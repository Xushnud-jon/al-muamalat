    ...
    <header ref={menuRef} className="bg-white shadow-md py-3 px-4 sm:px-6 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        >
          ...
          />
          <span className="text-xl font-bold text-[#009688] hidden sm:block">AL MUAMALAT</span>
        </div>
...
>
  Home
          ...
          <div className="relative">
            <button
              onClick={() => setProgramsDropdownOchiq(!programsDropdownOchiq)}
              className="flex items-center text-gray-700 hover:text-[#009688] font-medium cursor-pointer transition duration-200"
            >
              Programs
              <svg 
                className={`ml-1 w-4 h-4 transition-transform duration-200 ${programsDropdownOchiq ? 'rotate-180' : ''}`}
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
...
>
  Contact
        ...
        <div className="hidden md:flex items-center space-x-6">
          <div className="relative border-r">
            <button
              ...
              className="flex items-center text-gray-700 hover:text-indigo-600 px-3 py-1 rounded-md hover:bg-gray-100 transition duration-200"
            >
              <img src={tanlanganTil.bayroq} alt={tanlanganTil.kod} className="w-5 h-5 mr-2" />
              <span>{tanlanganTil.kod}</span>
          ...
          <button 
            ...
            className="bg-[#009688] hover:bg-[#00796b] text-white px-4 py-2 rounded-md transition duration-200 cursor-pointer"
          >
            Sign in
          </button>
        </div>
        ...
        <div className="md:hidden flex items-center space-x-3">
          ...
          <button 
            onClick={() => navigate('/login')} 
            className="bg-[#009688] hover:bg-[#00796b] text-white px-3 py-1.5 rounded-md text-sm cursor-pointer"
          >
            Sign in
          </button>
        ...
        <div className="md:hidden bg-white py-3 px-4 space-y-2  shadow-inner">
          ...
          <div className="relative" >
            <button
              ...
              className="w-full flex justify-between items-center py-2.5 px-3 text-gray-700 hover:text-[#009688] hover:bg-gray-50 rounded-md transition duration-200"
            >
              <span>Programs</span>
              <svg 
                className={`ml-1 w-4 h-4 transition-transform duration-200 ${programsDropdownOchiq ? 'rotate-180' : ''}`}
