          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-300  bg-white  rounded-xl px-5 py-3 pl-12 text-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-xl px-5 py-3 pl-12 pr-12 text-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full ${loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#01B98E] hover:bg-[#019b7b]"} cursor-pointer text-white py-3 rounded-xl text-lg font-semibold transition duration-300`}
            >
              {loading ? "Signing in..." : "Sign in"}
            </button>
          </form>

          <p className="mt-6 text-base text-gray-500 text-center cursor-pointer" onClick={() => navigate('/register')}>
